        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative">
              ...
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-gold-400/30 shadow-2xl max-w-full group/img">
                ...
                <img
                  ...
                  className="w-full max-w-[240px] xs:max-w-xs sm:max-w-sm object-cover object-top aspect-[3/4] h-[300px] xs:h-[340px] sm:h-[480px] transform scale-102 group-hover/img:scale-105 group-hover/img:brightness-105 group-hover/img:contrast-105 transition-all duration-700 ease-out"
                />
                
                {/* Badge Overlay */}
                <div className="absolute bottom-2 left-2 right-2 sm:bottom-4 sm:left-4 sm:right-4 bg-earth-950/90 border border-gold-400/30 p-2 sm:p-3 rounded-lg sm:rounded-xl backdrop-blur-md">
                  <p className="text-[10px] sm:text-xs text-gold-300 font-semibold uppercase tracking-wider text-center flex items-center justify-center gap-1 sm:gap-1.5">
                    <Sparkles className="h-3.5 w-3.5 sm:h-4.5 sm:w-4.5 text-gold-400" /> Isabelly Mariano
                  </p>
                  <p className="text-[8px] sm:text-[10px] text-zinc-400 text-center mt-0.5">Empresária e Mentora Fundadora</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <span className="inline-flex items-center gap-1 sm:gap-1.5 px-2.5 py-0.5 sm:px-3 sm:py-1 bg-gold-400/10 border border-gold-400/20 text-gold-400 text-[10px] sm:text-xs font-semibold uppercase tracking-widest rounded-full">
            ...
            <div className="text-zinc-300 space-y-3 sm:space-y-4 text-xs sm:text-base leading-relaxed font-sans">
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="flex gap-2.5 sm:gap-3 bg-earth-900/50 border border-gold-400/5 hover:border-gold-400/20 p-3 sm:p-4 rounded-xl transition-all duration-300">
                <div className="flex-shrink-0 h-8 w-8 sm:h-10 sm:w-10 bg-gold-400/10 rounded-lg flex items-center justify-center text-gold-400">
                  <Shield className="h-4 w-4 sm:h-5 sm:w-5" />
                </div>
                <div>
                  <h4 className="text-xs sm:text-sm font-bold text-white">Metodologia Ética</h4>
                  <p className="text-[10px] sm:text-xs text-zinc-400 mt-1">Livre de hacks enganosos, focada em construir um negócio legítimo no digital.</p>
                </div>
              </div>
              ...
              <div className="flex gap-2.5 sm:gap-3 bg-earth-900/50 border border-gold-400/5 hover:border-gold-400/20 p-3 sm:p-4 rounded-xl transition-all duration-300">
                ...
                <div>
                  <h4 className="text-xs sm:text-sm font-bold text-white">Suporte Direto</h4>
                  <p className="text-[10px] sm:text-xs text-zinc-400 mt-1">Acompanhamento ativo e constante para garantir que você tenha clareza.</p>
                </div>
              </div>
            </div>
          </motion.div>
